...
<div class="my_cookbook_list">
	<ul class="my_cookbook_list_ul"  style="width: 1180px;margin-left:0px;">
		...
		<div style="height: 180px;">
		    <div><a href="CookBook_recipe.php?food_id=<?php echo $row['id']; ?>"><img  src="<?php $imgs=fing_cookbook_img($dbc,$row['id']); echo $imgs; ?>" alt="" class="my_cookbook_list_img" ></a></div>
			...
			<a class="del" href="mc-CookBook.php?action=del&food_id=<?php echo $row['id']; ?>"><p style="margin-left: 30px;">删除</p></a>
